...
import { coursesList } from "../recoil/atom";
...
const Landing: React.FC = () => {
    ...
    const getRandomItemsFromArray = (arr: Coursetype[]) => {
                ...
                <section className="py-16">
                    <div className="container mx-auto">
                        ...
                        <div className="flex flex-wrap gap-12 justify-start items-center">
                            ...
                            {courses.state == "hasValue" && featuredCourses?.map(fc => <Course key={fc._id} course={fc} updateDel={false} />)}
                        </div>
                    </div>
                </section>
